...
# DEFAULT_MOVIE_NAMES_COL_RANGE_NAME = "WorkArea"


# # def iter_next_empty_in_cols(spreadsheet_id: str, range_name: str):
...
# def fetch_sheet(spreadsheet_id: str):
#     result = get_sheets_service().spreadsheets().values().get(
#         spreadsheetId=spreadsheet_id, range=f'A:K').execute()
#     return result['values']

# def fetch_row(spreadsheet_id: str, row_num: int):
#     result = get_sheets_service().spreadsheets().values().get(
#         spreadsheetId=spreadsheet_id, range=f'A{row_num}:K{row_num}').execute()
#     return result['values']


# def fetch_header(spreadsheet_id: str):
#     return fetch_row(spreadsheet_id, 1)


# def fetch_movie_slugs(spreadsheet_id: str, range_name: Optional[str] = DEFAULT_MOVIE_NAMES_COL_RANGE_NAME):
#     """
...
#     result = service.spreadsheets().values().get(
#         spreadsheetId=spreadsheet_id, range='A1:K1').execute()
#     rows = result.get('values', [])
